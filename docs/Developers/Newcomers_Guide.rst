...
.. note::
    ...
    **You do not need to read the coala codebase to get started** - this guide
    is intendet to help you getting started without reading tons of meaningless
...
Dear developers,
I have finished the newcomer guide and ask to be promoted to join the ranks of
coala developers.
